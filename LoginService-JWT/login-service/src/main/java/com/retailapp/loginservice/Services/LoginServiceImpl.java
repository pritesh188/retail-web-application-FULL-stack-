...
import com.retailapp.loginservice.JWT.JwtUtil;
...
public class LoginServiceImpl implements LoginService {
	...
	{
		return new ResponseEntity<String>(jwtUtil.generateToken(customerUserDetailService.getUserDetails().getEmail()),HttpStatus.OK);
